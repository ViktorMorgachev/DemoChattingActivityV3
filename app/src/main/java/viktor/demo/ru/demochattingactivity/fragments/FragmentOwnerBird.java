...
public class FragmentOwnerBird extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        imageView.setImageBitmap(getBitmapFromAssets("marina.png"));
